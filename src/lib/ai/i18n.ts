...
export const en = {
  ...
  v2: {
    ...
    labels: { decide: "Decide", renew: "Renew", open: "Open", logService: "Log service", approve: "Approve", remind: "Set reminder", createWo: "Create work order", briefing: "Open briefing", cashflow: "Open cash flow", suppliers: "Suppliers", rentRoll: "Rent roll" },
    thisYear: "this year",
    lastYear: "last year",
...
export const ar: Strings = {
  ...
  v2: {
    ...
    labels: { decide: "قرّر", renew: "جدّد", open: "افتح", logService: "سجّل الخدمة", approve: "وافق", remind: "ضبط تذكير", createWo: "إنشاء أمر عمل", briefing: "افتح الملخص", cashflow: "افتح التدفق النقدي", suppliers: "الموردون", rentRoll: "جدول الإيجارات" },
    thisYear: "هذه السنة",
