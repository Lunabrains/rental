...
export const en = {
  ...
  v2: {
    ...
    entryWhat: { building: "building", unit: "unit", tenant: "tenant", contract: "contract", asset: "asset", expense: "expense", supplier: "supplier", complaint: "complaint", vacate: "undertaking to vacate (تعهد بالإخلاء)" },
    ...
    entryNeedsTenant: "Tell me which tenant — by name or by unit — and I will open the form.",
    ...
    entryFields: { field: "Field", value: "Understood as", name: "Name", floors: "Floors", perFloor: "Units per floor", city: "City", building: "Building", unit: "Unit", floor: "Floor", bedrooms: "Bedrooms", bathrooms: "Bathrooms", size: "Size", rent: "Rent", deposit: "Deposit", tenant: "Tenant", phone: "Phone", email: "Email", start: "Start", months: "Months", type: "Type", brand: "Brand", model: "Model", serial: "Serial", cost: "Cost", amount: "Amount", category: "Category", description: "Description", supplier: "Supplier", date: "Date", company: "Company", summary: "Complaint", by: "Vacate by" },
    ytd: "year to date",
  },
...
export const ar: Strings = {
  ...
  v2: {
    ...
    entryWhat: { building: "مبنى", unit: "شقة", tenant: "مستأجر", contract: "عقد", asset: "أصل", expense: "مصروف", supplier: "مورد", complaint: "شكوى", vacate: "تعهد بالإخلاء" },
    entryUnknownBuilding: (name) => ` لم أجد مبنى باسم «${name}» — اختره في النموذج.`,
    entryNoBuilding: " اختر المبنى في النموذج.",
    entryNeedsTenant: "قل لي أي مستأجر — بالاسم أو برقم الشقة — وسأفتح النموذج.",
